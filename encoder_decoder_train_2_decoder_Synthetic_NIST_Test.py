...
weight_path = '/home/aniruddha-spina/Personal/Code/forgery_localization_HLED-master/Encoder_Decoder_SRM_RGB/keras-two-stream-encoder-decoder/GPU/2_Decoder/Dice/Synthetic_NIST_Casia_models/loss/model_weights.hd5'
model.load_weights(weight_path)




img_path = './Dataset/tifs-database/DSO-1/'
#mask_path = '/media/aniruddha-spina/Seagate Expansion Drive1/Lab_BackUp/Ubuntu/Dataset/NC2016_Test_Rev2_1018/NC2016_Test/256_256/Masks/'

pred_mask_path = './keras-two-stream-encoder-decoder/Predictions/2_Decoder/Model_Trained_on_Synthentic_NIST_Casia/Casia_Combined/Dice/DSO-1/authentic_image/Pred_Masks/'

pred_prob_array_path = './keras-two-stream-encoder-decoder/Predictions/2_Decoder/Model_Trained_on_Synthentic_NIST_Casia/Casia_Combined/Dice/DSO-1/authentic_image/Prob_array/'


imgDir = os.listdir(img_path)

imgDirTest = imgDir[len(imgDir)-16:]
...
for i in range(len(imgDir)):
    ...
    imgFilename = img_path + name
    #maskFilename = mask_path + name
    ...
    pred_mask_filename = pred_mask_path + name[:-4] + '.png'
    prob_arr_filename = pred_prob_array_path + name[:-4] + '.npy'
