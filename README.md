...
2. Additionally, we have provided a jupyter notebook file, i.e. Demo_Two_Stream_Encoder_Decoder.ipynb, containing the steps to run the inference code to generate the predictions.
